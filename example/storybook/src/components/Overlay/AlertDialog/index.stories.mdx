...
import {  AlertDialog,
  ...
  AlertDialogCloseButton,
  AlertDialogFooter,
  AlertDialogBody, } from '@gluestack-ui/themed';
```
...
Default styling of all these components can be found in the `components/core/alert-dialog` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/tree/main/example/storybook/src/ui-components/AlertDialog) of the styled `AlertDialog` components.
