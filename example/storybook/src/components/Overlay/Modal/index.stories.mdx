            ...
            <Center>
              ...
              >
                ...
                <ModalContent>
                  ...
                  <ModalBody>
                    <Input>
                      <InputInput placeholder="Enter your email" />
                    </Input>
                  </ModalBody>
              ...
              >
                ...
                <ModalContent>
                  ...
                  <ModalBody>
                    <Input>
                      <InputInput placeholder="Enter verification code" />
                    </Input>
                  </ModalBody>
                  <ModalFooter borderTopWidth='$0'>
                  <VStack space='lg' w='$full'>
              ...
              >
                ...
                <ModalContent>
                  ...
                  <VStack space='xl'>
                    <Input>
                      <InputInput placeholder="New password" />
                    </Input>
                    <Input>
                      <InputInput placeholder="Confirm new password" />
                    </Input>
                    </VStack>
                  </ModalBody>
                  <ModalFooter borderTopWidth='$0'>
...
Default styling of all these components can be found in the `components/core/modal` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/tree/main/example/storybook/src/ui-components/Modal) of the styled `Modal` components.
