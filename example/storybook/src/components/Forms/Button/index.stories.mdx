...
import { Text, Input, InputInput, Box, HStack, VStack } from './Button';
...
<AppProvider>
  <CodePreview
    ...
    metaData={{
      code: `
        <Button borderRadius='$full' size='lg' p='$4' bg='$indigo600' borderColor='$indigo600' >
...
Default styling of all these components can be found in the `components/core/button` file. For reference, you can view the [source code](https://github.com/gluestack/gluestack-ui/tree/main/example/storybook/src/ui-components/Button) of the styled `Button` components.
